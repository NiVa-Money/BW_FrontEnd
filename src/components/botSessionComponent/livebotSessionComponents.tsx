...
const LiveBotSessionComponent: React.FC = () => {
    ...
    const [isChatEnabled, setIsChatEnabled] = React.useState(false); // State to manage the toggle
        ...
        <div className="flex h-screen">
            ...
            >
                ...
                >
                    ...
                    <div className="mt-5 w-full max-w-[-200px] max-md:mt-10 max-md:max-w-full h-[61vh] rounded-lg relative">
                        <div
...
export default withAuth(LiveBotSessionComponent);
