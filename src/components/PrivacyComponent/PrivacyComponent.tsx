    ...
    <>
      ...
      <div className=" text-white p-6 rounded-lg">
        ...
        <p className="mb-6">
          ...
          Technologies Pvt Ltd ("PurpleAnt", "we", "us", or "our"). We are
          committed to protecting the privacy of our users ("you" or "your").
          This Privacy Policy explains how we collect, use, disclose, and
          safeguard your information when you use our AI-powered chatbot
        ...
        <ol>
          <li>
            Transparency: We explain how BotWot's AI works and how it uses chat
            data to improve the user experience.
          </li>
        </ol>
        <ol>
          <li>
            Accuracy: We are committed to providing accurate and unbiased
            information through BotWot's AI chat functionalities
          </li>
        </ol>
        <ol>
          <li>
            Bias: We address potential biases in the AI model and continuously
            work to mitigate them.
          </li>
        </ol>
        <ol>
          <li>
            Human Oversight: A human team monitors and oversees the AI to ensure
            its responsible use.
          </li>
        </ol>
        <p className="mt-6 mb-6 text-md font-bold">
          Please review this Privacy Policy carefully. By using BotWot, you
