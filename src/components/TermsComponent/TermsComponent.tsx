  ...
  return (
    <>
      ...
      <div className=" text-white p-6 rounded-lg">
        ...
        <p className="mb-6">
          Welcome to Botwot, a product of PurpleAnt Technologies Private Limited
          ("PurpleAnt," "we," "us," or "our"). These Terms and Conditions govern
          your use of Botwot and its associated services. By accessing or using
          Botwot, you agree to be bound by these Terms and Conditions.{' '}
        </p>
        ...
        {termsSections.map((section, index) => (
          <div key={index} className="mb-6">
            ...
            {expanded === index && (
              <p className="pl-4 mb-4 whitespace-pre-wrap text-left">
                {section.content}
              </p>
            )}
        ...
        <p className="mt-6 mb-6 text-md font-bold">
          Please read these Terms and Conditions carefully. Your continued use
          of Botwot constitutes your acceptance of these terms.
        </p>
      </div>
    </>
  );
