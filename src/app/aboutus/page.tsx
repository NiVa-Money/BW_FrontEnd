        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white-800 mb-4">
              ...
              users through product purchases, and personalize online
              experiences. Traditionally, building a chatbot required coding
              expertise, limiting its accessibility to businesses.
            </p>
            <p className="text-white-800 mb-4">
              BotWot.io is here to change that. Our platform empowers anyone,
              regardless of technical background, to build and deploy a custom
              AI chatbot in minutes. This removes a significant barrier for
