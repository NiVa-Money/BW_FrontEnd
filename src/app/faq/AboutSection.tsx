...
return (
  <div className="flex overflow-hidden flex-col px-12 py-24 max-md:px-5">
    ...
    <div className="flex overflow-hidden relative flex-col items-start mt-12 w-full text-base text-white h-[324px] max-w-[1030px] max-md:mt-10 max-md:max-w-full">
      ...
      <div className="flex absolute right-0 bottom-0 z-0 flex-wrap gap-1.5 justify-center items-center p-2.5 leading-none w-[1030px]">
        ...
        <img
          ...
          className="object-contain shrink-0 self-stretch my-auto aspect-[1.02] w-[41px]"
        />
      </div>
    </div>
  </div>
